#include "header.h"
/**
 * change_dir - Directory Change
 * @cmd: Parsed command
 * @st: Status command executed
...
/**
 * dis_env - Display enviroment vars
 * @cmd: parsed command
...
/**
 * echo_bul - execute ech
 * @st: statue of last command 
 * @cmd: parsed command
 * Return: Always 1 Or execute
 */
